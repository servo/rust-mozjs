...
extern "C" {
    #[link_name =
          "?formatSliceMessage@GCDescription@JS@@QEBAPEA_WPEAUJSRuntime@@@Z"]
    fn _formatSliceMessage_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___Z_(this:
                                                                             *mut GCDescription,
                                                                         rt:
                                                                             *mut JSRuntime)
     -> *mut char16_t;
    #[link_name =
          "?formatSummaryMessage@GCDescription@JS@@QEBAPEA_WPEAUJSRuntime@@@Z"]
    fn _formatSummaryMessage_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___Z_(this:
                                                                               *mut GCDescription,
                                                                           rt:
                                                                               *mut JSRuntime)
     -> *mut char16_t;
    #[link_name =
          "?formatJSON@GCDescription@JS@@QEBAPEA_WPEAUJSRuntime@@_K@Z"]
    fn _formatJSON_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___K_Z_(this:
                                                                       *mut GCDescription,
                                                                   rt:
                                                                       *mut JSRuntime,
                                                                   timestamp:
...
impl GCDescription {
    ...
    pub unsafe fn formatSliceMessage(&mut self, rt: *mut JSRuntime)
     -> *mut char16_t {
        _formatSliceMessage_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___Z_(&mut *self,
                                                                          rt)
    }
    #[inline]
    pub unsafe fn formatSummaryMessage(&mut self, rt: *mut JSRuntime)
     -> *mut char16_t {
        _formatSummaryMessage_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___Z_(&mut *self,
                                                                            rt)
    }
    #[inline]
    pub unsafe fn formatJSON(&mut self, rt: *mut JSRuntime, timestamp: u64)
     -> *mut char16_t {
        _formatJSON_GCDescription_JS__QEBAPEA_WPEAUJSRuntime___K_Z_(&mut *self,
                                                                    rt,
                                                                    timestamp)
    }
}
...
pub struct TransitiveCompileOptions {
    ...
    pub sourceMapURL_: *const char16_t,
...
extern "C" {
    ...
    fn _introducerFilename_TransitiveCompileOptions_JS__QEBAPEBDXZ_(this:
                                                                        *mut TransitiveCompileOptions)
     -> *const ::std::os::raw::c_char;
    #[link_name = "?sourceMapURL@TransitiveCompileOptions@JS@@QEBAPEB_WXZ"]
    fn _sourceMapURL_TransitiveCompileOptions_JS__QEBAPEB_WXZ_(this:
                                                                   *mut TransitiveCompileOptions)
     -> *const char16_t;
}
impl TransitiveCompileOptions {
    ...
    #[inline]
    pub unsafe fn sourceMapURL(&mut self) -> *const char16_t {
        _sourceMapURL_TransitiveCompileOptions_JS__QEBAPEB_WXZ_(&mut *self)
    }
}
#[repr(C)]
...
pub type JSONWriteCallback =
    ::std::option::Option<unsafe extern "C" fn(buf: *const char16_t, len: u32,
                                               data:
                                                   *mut ::std::os::raw::c_void)
                              -> bool>;
/**
...
pub struct JSErrorReport {
    ...
    pub ucmessage: *const char16_t,
    pub messageArgs: *mut *const char16_t,
    pub exnType: i16,
}
...
pub type OpenAsmJSCacheEntryForReadOp =
    ::std::option::Option<unsafe extern "C" fn(global: HandleObject,
                                               begin: *const char16_t,
                                               limit: *const char16_t,
                                               size: *mut usize,
                                               memory: *mut *const u8,
...
pub struct String_jsfriendapi_h_unnamed_13 {
    ...
    pub nonInlineCharsTwoByte: __BindgenUnionField<*const char16_t>,
    pub inlineStorageLatin1: __BindgenUnionField<[Latin1Char; 1usize]>,
    pub inlineStorageTwoByte: __BindgenUnionField<[char16_t; 1usize]>,
    pub _bindgen_data_: u64,
}
impl String_jsfriendapi_h_unnamed_13 {
    ...
    pub unsafe fn nonInlineCharsTwoByte(&mut self) -> *mut *const char16_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    ...
    pub unsafe fn inlineStorageTwoByte(&mut self) -> *mut [char16_t; 1usize] {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub struct AutoStableStringChars_jsfriendapi_h_unnamed_14 {
    pub twoByteChars_: __BindgenUnionField<*const char16_t>,
    pub latin1Chars_: __BindgenUnionField<*const Latin1Char>,
    pub _bindgen_data_: u64,
}
impl AutoStableStringChars_jsfriendapi_h_unnamed_14 {
    pub unsafe fn twoByteChars_(&mut self) -> *mut *const char16_t {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
 ...
 */
    #[link_name =
          "?JS_NewExternalString@@YAPEAVJSString@@PEAUJSContext@@PEB_W_KPEBUJSStringFinalizer@@@Z"]
    pub fn JS_NewExternalString(cx: *mut JSContext, chars: *const char16_t,
 ...
 */
    ...
    pub fn JS_GetOwnPropertyDescriptor(cx: *mut JSContext, obj: HandleObject,
     ...
     -> bool;
    #[link_name =
          "?JS_GetOwnUCPropertyDescriptor@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_WV?$MutableHandle@UPropertyDescriptor@JS@@@3@@Z"]
 ...
 */
    ...
    pub fn JS_DefineProperty5(cx: *mut JSContext, obj: HandleObject,
                              ...
                              setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$Handle@UPropertyDescriptor@JS@@@3@AEAVObjectOpResult@3@@Z"]
    pub fn JS_DefineUCProperty(cx: *mut JSContext, obj: HandleObject,
                               name: *const char16_t, namelen: usize,
                               desc: Handle<PropertyDescriptor>,
                               result: *mut ObjectOpResult) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$Handle@UPropertyDescriptor@JS@@@3@@Z"]
    pub fn JS_DefineUCProperty1(cx: *mut JSContext, obj: HandleObject,
                                name: *const char16_t, namelen: usize,
                                desc: Handle<PropertyDescriptor>) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$Handle@VValue@JS@@@3@IP6A_N0IPEAVValue@3@@Z6@Z"]
    pub fn JS_DefineUCProperty2(cx: *mut JSContext, obj: HandleObject,
                                ...
                                getter: JSNative, setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_K1IP6A_N0IPEAVValue@3@@Z5@Z"]
    pub fn JS_DefineUCProperty3(cx: *mut JSContext, obj: HandleObject,
                                ...
                                getter: JSNative, setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$Handle@PEAVJSString@@@3@IP6A_N0IPEAVValue@3@@Z6@Z"]
    pub fn JS_DefineUCProperty4(cx: *mut JSContext, obj: HandleObject,
                                ...
                                getter: JSNative, setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KHIP6A_N0IPEAVValue@3@@Z5@Z"]
    pub fn JS_DefineUCProperty5(cx: *mut JSContext, obj: HandleObject,
                                name: *const char16_t, namelen: usize,
                                value: i32, attrs: ::std::os::raw::c_uint,
                                getter: JSNative, setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KIIP6A_N0IPEAVValue@3@@Z5@Z"]
    pub fn JS_DefineUCProperty6(cx: *mut JSContext, obj: HandleObject,
                                name: *const char16_t, namelen: usize,
                                value: u32, attrs: ::std::os::raw::c_uint,
                                getter: JSNative, setter: JSNative) -> bool;
    #[link_name =
          "?JS_DefineUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KNIP6A_N0IPEAVValue@3@@Z5@Z"]
 ...
 */
    ...
    pub fn JS_HasProperty(cx: *mut JSContext, obj: HandleObject,
                          ...
                          foundp: *mut bool) -> bool;
    #[link_name =
          "?JS_HasUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KPEA_N@Z"]
 ...
 */
    ...
    pub fn JS_GetProperty(cx: *mut JSContext, obj: HandleObject,
                          ...
                          vp: MutableHandleValue) -> bool;
    #[link_name =
          "?JS_GetUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$MutableHandle@VValue@JS@@@3@@Z"]
 ...
 */
    ...
    pub fn JS_SetProperty(cx: *mut JSContext, obj: HandleObject,
     ...
     -> bool;
    #[link_name =
          "?JS_SetUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KV?$Handle@VValue@JS@@@3@@Z"]
 ...
 */
    ...
    pub fn JS_DeleteProperty(cx: *mut JSContext, obj: HandleObject,
                             ...
                             result: *mut ObjectOpResult) -> bool;
    #[link_name =
          "?JS_DeleteUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KAEAVObjectOpResult@3@@Z"]
 ...
 */
    ...
    pub fn JS_AlreadyHasOwnProperty(cx: *mut JSContext, obj: HandleObject,
                                    ...
                                    foundp: *mut bool) -> bool;
    #[link_name =
          "?JS_AlreadyHasOwnUCProperty@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KPEA_N@Z"]
 ...
 */
    ...
    pub fn JS_DefineFunction(cx: *mut JSContext, obj: Handle<*mut JSObject>,
     ...
     -> *mut JSFunction;
    #[link_name =
          "?JS_DefineUCFunction@@YAPEAVJSFunction@@PEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEB_W_KP6A_N0IPEAVValue@4@@ZII@Z"]
 ...
 */
    #[link_name =
          "?JS_CompileUCScript@@YA_NPEAUJSContext@@PEB_W_KAEBVCompileOptions@JS@@V?$MutableHandle@PEAVJSScript@@@3@@Z"]
    pub fn JS_CompileUCScript(cx: *mut JSContext, chars: *const char16_t,
                              length: usize, options: *const CompileOptions,
                              script: MutableHandleScript) -> bool;
 ...
 */
    ...
    pub fn Compile1(cx: *mut JSContext,
                    ...
                    script: MutableHandleScript) -> bool;
    #[link_name =
          "?Compile@JS@@YA_NPEAUJSContext@@AEBVReadOnlyCompileOptions@1@PEB_W_KV?$MutableHandle@PEAVJSScript@@@1@@Z"]
    pub fn Compile2(cx: *mut JSContext,
                    options: *const ReadOnlyCompileOptions,
                    chars: *const char16_t, length: usize,
                    script: MutableHandleScript) -> bool;
    #[link_name =
    ...
    pub fn CompileForNonSyntacticScope1(cx: *mut JSContext,
                                        ...
                                        script: MutableHandleScript) -> bool;
    #[link_name =
          "?CompileForNonSyntacticScope@JS@@YA_NPEAUJSContext@@AEBVReadOnlyCompileOptions@1@PEB_W_KV?$MutableHandle@PEAVJSScript@@@1@@Z"]
    ...
    pub fn CanCompileOffThread(cx: *mut JSContext,
                               ...
                               length: usize) -> bool;
    #[link_name =
          "?CompileOffThread@JS@@YA_NPEAUJSContext@@AEBVReadOnlyCompileOptions@1@PEB_W_KP6AXPEAX4@Z4@Z"]
 ...
 */
    #[link_name =
          "?CompileFunction@JS@@YA_NPEAUJSContext@@AEAV?$AutoVectorRooter@PEAVJSObject@@@1@AEBVReadOnlyCompileOptions@1@PEBDIPEBQEBDPEB_W_KV?$MutableHandle@PEAVJSFunction@@@1@@Z"]
 ...
 */
    #[link_name =
          "?Evaluate@JS@@YA_NPEAUJSContext@@AEBVReadOnlyCompileOptions@1@PEB_W_KV?$MutableHandle@VValue@JS@@@1@@Z"]
 ...
 */
    #[link_name =
          "?Evaluate@JS@@YA_NPEAUJSContext@@AEAV?$AutoVectorRooter@PEAVJSObject@@@1@AEBVReadOnlyCompileOptions@1@PEB_W_KV?$MutableHandle@VValue@JS@@@1@@Z"]
 ...
 */
    ...
    pub fn JS_AtomizeAndPinString(cx: *mut JSContext,
                                  s: *const ::std::os::raw::c_char)
     -> *mut JSString;
    #[link_name = "?JS_NewUCString@@YAPEAVJSString@@PEAUJSContext@@PEA_W_K@Z"]
    pub fn JS_NewUCString(cx: *mut JSContext, chars: *mut char16_t,
                          length: usize) -> *mut JSString;
    #[link_name =
          "?JS_NewUCStringCopyN@@YAPEAVJSString@@PEAUJSContext@@PEB_W_K@Z"]
    pub fn JS_NewUCStringCopyN(cx: *mut JSContext, s: *const char16_t,
                               n: usize) -> *mut JSString;
    #[link_name =
          "?JS_NewUCStringCopyZ@@YAPEAVJSString@@PEAUJSContext@@PEB_W@Z"]
    pub fn JS_NewUCStringCopyZ(cx: *mut JSContext, s: *const char16_t)
     -> *mut JSString;
    #[link_name =
          "?JS_AtomizeUCStringN@@YAPEAVJSString@@PEAUJSContext@@PEB_W_K@Z"]
    pub fn JS_AtomizeUCStringN(cx: *mut JSContext, s: *const char16_t,
                               length: usize) -> *mut JSString;
    #[link_name =
          "?JS_AtomizeUCString@@YAPEAVJSString@@PEAUJSContext@@PEB_W@Z"]
    pub fn JS_AtomizeUCString(cx: *mut JSContext, s: *const char16_t)
     -> *mut JSString;
    #[link_name =
          "?JS_AtomizeAndPinUCStringN@@YAPEAVJSString@@PEAUJSContext@@PEB_W_K@Z"]
    pub fn JS_AtomizeAndPinUCStringN(cx: *mut JSContext, s: *const char16_t,
                                     length: usize) -> *mut JSString;
    #[link_name =
          "?JS_AtomizeAndPinUCString@@YAPEAVJSString@@PEAUJSContext@@PEB_W@Z"]
    pub fn JS_AtomizeAndPinUCString(cx: *mut JSContext, s: *const char16_t)
     -> *mut JSString;
    #[link_name =
    ...
    pub fn JS_GetLatin1StringCharsAndLength(cx: *mut JSContext,
     ...
     -> *const Latin1Char;
    #[link_name =
          "?JS_GetTwoByteStringCharsAndLength@@YAPEB_WPEAUJSContext@@AEBVAutoCheckCannotGC@JS@@PEAVJSString@@PEA_K@Z"]
    pub fn JS_GetTwoByteStringCharsAndLength(cx: *mut JSContext,
     ...
     -> *const char16_t;
    #[link_name =
          "?JS_GetStringCharAt@@YA_NPEAUJSContext@@PEAVJSString@@_KPEA_W@Z"]
    pub fn JS_GetStringCharAt(cx: *mut JSContext, str: *mut JSString,
                              index: usize, res: *mut char16_t) -> bool;
    #[link_name = "?JS_GetFlatStringCharAt@@YA_WPEAVJSFlatString@@_K@Z"]
    pub fn JS_GetFlatStringCharAt(str: *mut JSFlatString, index: usize)
     -> char16_t;
    #[link_name =
          "?JS_GetTwoByteExternalStringChars@@YAPEB_WPEAVJSString@@@Z"]
    pub fn JS_GetTwoByteExternalStringChars(str: *mut JSString)
     -> *const char16_t;
    #[link_name =
          "?JS_CopyStringChars@@YA_NPEAUJSContext@@V?$Range@_W@mozilla@@PEAVJSString@@@Z"]
    pub fn JS_CopyStringChars(cx: *mut JSContext,
                              dest: Range<::std::os::raw::c_short>,
    ...
    pub fn JS_GetLatin1FlatStringChars(nogc: *const AutoCheckCannotGC,
     ...
     -> *const Latin1Char;
    #[link_name =
          "?JS_GetTwoByteFlatStringChars@@YAPEB_WAEBVAutoCheckCannotGC@JS@@PEAVJSFlatString@@@Z"]
 ...
 * transcoded string.
 */
    #[link_name = "?JS_DecodeBytes@@YA_NPEAUJSContext@@PEBD_KPEA_WPEA_K@Z"]
    pub fn JS_DecodeBytes(cx: *mut JSContext,
                          src: *const ::std::os::raw::c_char, srclen: usize,
                          dst: *mut char16_t, dstlenp: *mut usize) -> bool;
    /**
 ...
 */
    #[link_name =
          "?JS_Stringify@@YA_NPEAUJSContext@@V?$MutableHandle@VValue@JS@@@JS@@V?$Handle@PEAVJSObject@@@3@V?$Handle@VValue@JS@@@3@P6A_NPEB_WIPEAX@Z5@Z"]
 ...
 */
    #[link_name =
          "?ToJSONMaybeSafely@JS@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@1@P6A_NPEB_WIPEAX@Z3@Z"]
 ...
 */
    #[link_name =
          "?JS_ParseJSON@@YA_NPEAUJSContext@@PEB_WIV?$MutableHandle@VValue@JS@@@JS@@@Z"]
    pub fn JS_ParseJSON(cx: *mut JSContext, chars: *const char16_t, len: u32,
                        vp: MutableHandleValue) -> bool;
    #[link_name =
    ...
    pub fn JS_ParseJSON1(cx: *mut JSContext, str: HandleString,
                         vp: MutableHandleValue) -> bool;
    #[link_name =
          "?JS_ParseJSONWithReviver@@YA_NPEAUJSContext@@PEB_WIV?$Handle@VValue@JS@@@JS@@V?$MutableHandle@VValue@JS@@@3@@Z"]
    pub fn JS_ParseJSONWithReviver(cx: *mut JSContext, chars: *const char16_t,
 ...
 */
    ...
    pub fn JS_ReportErrorNumberUC(cx: *mut JSContext,
                                  ...
                                  errorNumber: ::std::os::raw::c_uint, ...);
    #[link_name =
          "?JS_ReportErrorNumberUCArray@@YAXPEAUJSContext@@P6APEBUJSErrorFormatString@@PEAXI@Z1IPEAPEB_W@Z"]
    pub fn JS_ReportErrorNumberUCArray(cx: *mut JSContext,
                                       errorCallback: JSErrorCallback,
                                       userRef: *mut ::std::os::raw::c_void,
                                       errorNumber: ::std::os::raw::c_uint,
                                       args: *mut *const char16_t);
    /**
 ...
 */
    ...
    pub fn JS_NewRegExpObject(cx: *mut JSContext,
     ...
     -> *mut JSObject;
    #[link_name =
          "?JS_NewUCRegExpObject@@YAPEAVJSObject@@PEAUJSContext@@PEB_W_KI@Z"]
    pub fn JS_NewUCRegExpObject(cx: *mut JSContext, chars: *const char16_t,
                                length: usize, flags: ::std::os::raw::c_uint)
     -> *mut JSObject;
    #[link_name =
    ...
    pub fn JS_ClearRegExpStatics(cx: *mut JSContext, obj: HandleObject)
     -> bool;
    #[link_name =
          "?JS_ExecuteRegExp@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@1PEA_W_KPEA_K_NV?$MutableHandle@VValue@JS@@@3@@Z"]
    pub fn JS_ExecuteRegExp(cx: *mut JSContext, obj: HandleObject,
                            reobj: HandleObject, chars: *mut char16_t,
                            length: usize, indexp: *mut usize, test: bool,
                            rval: MutableHandleValue) -> bool;
    #[link_name =
          "?JS_ExecuteRegExpNoStatics@@YA_NPEAUJSContext@@V?$Handle@PEAVJSObject@@@JS@@PEA_W_KPEA_K_NV?$MutableHandle@VValue@JS@@@3@@Z"]
    pub fn JS_ExecuteRegExpNoStatics(cx: *mut JSContext, reobj: HandleObject,
                                     chars: *mut char16_t, length: usize,
                                     indexp: *mut usize, test: bool,
                                     rval: MutableHandleValue) -> bool;
    /**
 ...
 * identifier.
 */
    #[link_name = "?JS_IsIdentifier@@YA_NPEB_W_K@Z"]
    pub fn JS_IsIdentifier1(chars: *const char16_t, length: usize) -> bool;
    /**
 ...
 */
    ...
    #[link_name = "?DumpChars@js@@YAXPEB_W_K@Z"]
    pub fn DumpChars(s: *const char16_t, n: usize);
