...
extern "C" {
    fn _ZNK2JS13GCDescription13formatMessageEP9JSRuntime(this: *mut GCDescription,
                                                         rt: *mut JSRuntime)
                                                         -> *mut u16;
    fn _ZNK2JS13GCDescription10formatJSONEP9JSRuntimey(this: *mut GCDescription,
                                                       rt: *mut JSRuntime,
                                                       timestamp: u64)
                                                       -> *mut u16;
}
impl GCDescription {
    ...
    pub unsafe fn formatJSON(&mut self, rt: *mut JSRuntime, timestamp: u64) -> *mut u16 {
        _ZNK2JS13GCDescription10formatJSONEP9JSRuntimey(&mut *self, rt, timestamp)
    }
}
...
extern "C" {
    ...
    fn _ZN27JSAutoStructuredCloneBuffer4copyEPKyyj(this: *mut JSAutoStructuredCloneBuffer,
                                                   data: *const u64,
                                                   nbytes: size_t,
                                                   version: u32)
                                                   -> bool;
    fn _ZN27JSAutoStructuredCloneBuffer5adoptEPyyj(this: *mut JSAutoStructuredCloneBuffer,
                                                   data: *mut u64,
                                                   nbytes: size_t,
                                                   version: u32);
    fn _ZN27JSAutoStructuredCloneBuffer5stealEPPyS0_Pj(this: *mut JSAutoStructuredCloneBuffer,
                                                       datap: *mut *mut u64,
                                                       nbytesp: *mut size_t,
                                                       versionp: *mut u32);
...
impl JSAutoStructuredCloneBuffer {
    ...
    pub unsafe fn copy(&mut self, data: *const u64, nbytes: size_t, version: u32) -> bool {
        _ZN27JSAutoStructuredCloneBuffer4copyEPKyyj(&mut *self, data, nbytes, version)
    }
    #[inline]
    pub unsafe fn adopt(&mut self, data: *mut u64, nbytes: size_t, version: u32) {
        _ZN27JSAutoStructuredCloneBuffer5adoptEPyyj(&mut *self, data, nbytes, version)
    }
    #[inline]
    pub unsafe fn steal(&mut self,
                        ...
                        nbytesp: *mut size_t,
                        versionp: *mut u32) {
        _ZN27JSAutoStructuredCloneBuffer5stealEPPyS0_Pj(&mut *self, datap, nbytesp, versionp)
    }
    #[inline]
