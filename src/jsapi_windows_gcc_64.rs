...
extern "C" {
    ...
    fn _ZNK8JSTracer11tracingNameEPKc(this: *mut JSTracer,
     ...
     -> *const ::libc::c_char;
    fn _ZN8JSTracer18getTracingEdgeNameEPcy(this: *mut JSTracer,
...
impl JSTracer {
    ...
    pub unsafe fn getTracingEdgeName(&mut self, buffer: *mut ::libc::c_char,
                                     bufferSize: size_t)
     -> *const ::libc::c_char {
        _ZN8JSTracer18getTracingEdgeNameEPcy(&mut *self, buffer, bufferSize)
    }
    #[inline]
...
extern "C" {
    ...
    fn _ZN27JSAutoStructuredCloneBuffer4copyEPKyyj(this:
                                                       *mut JSAutoStructuredCloneBuffer,
                                                   data: *const u64,
                                                   nbytes: size_t,
                                                   version: u32) -> bool;
    fn _ZN27JSAutoStructuredCloneBuffer5adoptEPyyj(this:
                                                       *mut JSAutoStructuredCloneBuffer,
                                                   data: *mut u64,
                                                   nbytes: size_t,
                                                   version: u32);
    fn _ZN27JSAutoStructuredCloneBuffer5stealEPPyS0_Pj(this:
                                                           *mut JSAutoStructuredCloneBuffer,
                                                       datap: *mut *mut u64,
                                                       nbytesp: *mut size_t,
                                                       versionp: *mut u32);
...
impl JSAutoStructuredCloneBuffer {
    ...
    pub unsafe fn copy(&mut self, data: *const u64, nbytes: size_t,
                       version: u32) -> bool {
        _ZN27JSAutoStructuredCloneBuffer4copyEPKyyj(&mut *self, data, nbytes,
                                                    version)
    }
    #[inline]
    pub unsafe fn adopt(&mut self, data: *mut u64, nbytes: size_t,
                        version: u32) {
        _ZN27JSAutoStructuredCloneBuffer5adoptEPyyj(&mut *self, data, nbytes,
                                                    version)
    }
    #[inline]
    pub unsafe fn steal(&mut self, datap: *mut *mut u64, nbytesp: *mut size_t,
                        versionp: *mut u32) {
        _ZN27JSAutoStructuredCloneBuffer5stealEPPyS0_Pj(&mut *self, datap,
                                                        nbytesp, versionp)
    }
    #[inline]
...
extern "C" {
    ...
    #[link_name = "_Z20JS_GetTraceThingInfoPcyP8JSTracerPv13JSGCTraceKindb"]
 ...
 */
    ...
    pub fn JS_DefineUCProperty5(cx: *mut JSContext, obj: HandleObject,
                                ...
                                setter: JSNative) -> bool;
    #[link_name =
          "_Z19JS_DefineUCPropertyP9JSContextN2JS6HandleIP8JSObjectEEPKDsyNS2_I20JSPropertyDescriptorEERNS1_14ObjectOpResultE"]
    pub fn JS_DefineUCProperty6(cx: *mut JSContext, obj: HandleObject,
                                name: *const u16, namelen: size_t,
                                desc: Handle<JSPropertyDescriptor>,
                                result: *mut ObjectOpResult) -> bool;
    #[link_name =
          "_Z19JS_DefineUCPropertyP9JSContextN2JS6HandleIP8JSObjectEEPKDsyNS2_I20JSPropertyDescriptorEE"]
 ...
 */
    #[link_name =
          "_ZN2JS15CompileFunctionEP9JSContextRNS_16AutoObjectVectorERKNS_22ReadOnlyCompileOptionsEPKcjPKS8_PKDsyNS_13MutableHandleIP10JSFunctionEE"]
 ...
 */
    #[link_name =
          "_ZN2JS15CompileFunctionEP9JSContextRNS_16AutoObjectVectorERKNS_22ReadOnlyCompileOptionsEPKcjPKS8_S8_yNS_13MutableHandleIP10JSFunctionEE"]
    ...
    pub fn Evaluate2(cx: *mut JSContext,
                     ...
                     rval: MutableHandleValue) -> bool;
    #[link_name =
          "_ZN2JS8EvaluateEP9JSContextRNS_16AutoObjectVectorERKNS_22ReadOnlyCompileOptionsEPKDsyNS_13MutableHandleINS_5ValueEEE"]
    ...
    pub fn JS_InternJSString(cx: *mut JSContext, str: HandleString)
     -> *mut JSString;
    #[link_name = "_Z16JS_InternStringNP9JSContextPKcy"]
    ...
    pub fn JS_NewUCStringCopyZ(cx: *mut JSContext, s: *const u16)
     -> *mut JSString;
    #[link_name = "_Z18JS_InternUCStringNP9JSContextPKDsy"]
    ...
    #[link_name =
          "_Z18JS_NewRegExpObjectP9JSContextN2JS6HandleIP8JSObjectEEPKcyj"]
    pub fn JS_NewRegExpObject(cx: *mut JSContext, obj: HandleObject,
                              bytes: *const ::libc::c_char, length: size_t,
                              flags: u32) -> *mut JSObject;
    #[link_name =
          "_Z20JS_NewUCRegExpObjectP9JSContextN2JS6HandleIP8JSObjectEEPKDsyj"]
    ...
    pub fn JS_ExecuteRegExp(cx: *mut JSContext, obj: HandleObject,
                            ...
                            rval: MutableHandleValue) -> bool;
    #[link_name = "_Z27JS_NewRegExpObjectNoStaticsP9JSContextPcyj"]
    pub fn JS_NewRegExpObjectNoStatics(cx: *mut JSContext,
                                       bytes: *mut ::libc::c_char,
                                       length: size_t, flags: u32)
     -> *mut JSObject;
    #[link_name = "_Z29JS_NewUCRegExpObjectNoStaticsP9JSContextPDsyj"]
    ...
    #[link_name =
          "_ZN2js16DumpHeapCompleteEP9JSRuntimeP6_iobufNS_24DumpHeapNurseryBehaviourE"]
    ...
    #[link_name =
          "_Z23JS_ClearStructuredClonePyyPK26JSStructuredCloneCallbacksPv"]
