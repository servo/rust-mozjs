...
extern "C" {
    ...
    fn _ZN27JSAutoStructuredCloneBuffer4copyEPKyjj(this: *mut JSAutoStructuredCloneBuffer,
                                                   data: *const u64,
                                                   nbytes: size_t,
                                                   version: u32)
                                                   -> bool;
    fn _ZN27JSAutoStructuredCloneBuffer5adoptEPyjj(this: *mut JSAutoStructuredCloneBuffer,
                                                   data: *mut u64,
                                                   nbytes: size_t,
                                                   version: u32);
    fn _ZN27JSAutoStructuredCloneBuffer5stealEPPyPjS2_(this: *mut JSAutoStructuredCloneBuffer,
                                                       datap: *mut *mut u64,
                                                       nbytesp: *mut size_t,
                                                       versionp: *mut u32);
...
impl JSAutoStructuredCloneBuffer {
    ...
    pub unsafe fn copy(&mut self, data: *const u64, nbytes: size_t, version: u32) -> bool {
        _ZN27JSAutoStructuredCloneBuffer4copyEPKyjj(&mut *self, data, nbytes, version)
    }
    #[inline]
    pub unsafe fn adopt(&mut self, data: *mut u64, nbytes: size_t, version: u32) {
        _ZN27JSAutoStructuredCloneBuffer5adoptEPyjj(&mut *self, data, nbytes, version)
    }
    #[inline]
    pub unsafe fn steal(&mut self,
                        ...
                        nbytesp: *mut size_t,
                        versionp: *mut u32) {
        _ZN27JSAutoStructuredCloneBuffer5stealEPPyPjS2_(&mut *self, datap, nbytesp, versionp)
    }
    #[inline]
