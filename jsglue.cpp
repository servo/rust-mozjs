...
class WrapperProxyHandler : public js::DirectWrapper
{
  ...
  public:
    ...
    bool baseHas(JSContext *cx, JSObject *proxy, jsid id, bool *bp)
    {
        return DirectWrapper::has(cx, proxy, id, bp);
    }
    ...
    bool baseHasOwn(JSContext *cx, JSObject *proxy, jsid id, bool *bp)
    {
        return DirectWrapper::hasOwn(cx, proxy, id, bp);
    }
    ...
    bool baseGet(JSContext *cx, JSObject *proxy, JSObject *receiver,
                 jsid id, JS::Value *vp)
    {
        return DirectWrapper::get(cx, proxy, receiver, id, vp);
    }
